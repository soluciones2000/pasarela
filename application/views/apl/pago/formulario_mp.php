	...
	<div class="col-md-8 center-block no-float">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				<?php echo form_open('validacion_mp','class="form-horizontal" id="pay" name="pay"',$hidden); ?>
...
<!--						<input type="text" name="card_mes" value="<?php echo set_value('card_mes') ?>" class="form-control">
			...
			<div class="panel-footer">
				Esta transacción será procesada de forma segura gracias a la plataforma de Mercadopago<br>
			<!--
